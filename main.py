...
<body>
 ...
 This is essentially an AI-powered exploration tool trying to find needles (coherent text) in an astronomically large haystack (the Library of Babel's random text space). The prize? Every book, poem or idea that ever has been or ever will be written lies within the Library of Babel...waiting for a clever librarian.</p>
  ...
  <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #0f0;">
    <a href="https://github.com/eriksyvertsen/Mining-the-Library-of-Babel" target="_blank" style="margin: 0 15px; text-decoration: none; color: #0ff;">
      <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" style="vertical-align: middle; margin-right: 8px;">
    ...
    <a href="https://x.com/Erik_Syvertsen" target="_blank" style="margin: 0 15px; text-decoration: none; color: #0ff;">
      <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24" style="vertical-align: middle; margin-right: 8px;">
